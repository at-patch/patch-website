...
export default function StoreError({
  ...
  useEffect(() => {
    logError("Unhandled error in store boundary", error, { digest: error.digest });
  }, [error]);
  ...
  return (
    <div className="mx-auto flex max-w-lg flex-col items-center justify-center px-6 py-32 text-center">
      ...
      <h1 className="font-heading mt-2 text-2xl font-extrabold tracking-tight text-patch-ink">
        Something went wrong
      </h1>
      <p className="mt-3 text-sm text-patch-ink-muted">
        Give it another try, or head back and pick up where you left off.
      </p>
